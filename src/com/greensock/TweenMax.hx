...
extern class TweenMax extends TweenLite
{
	 ...
	 * @return
	 */
	static public function delayedCall(delay:Float, callbackFunc:Dynamic, ?params:Array<Dynamic>, ?scope:Dynamic, ?useFrames:Bool):TweenMax;
	 ...
	 * @return
	 */
	static public function from (target: Dynamic, duration: Float, properties: Dynamic) : TweenMax;
	 ...
	 * @return
	 */
	static public function set( target:Dynamic, properties:Dynamic) : TweenMax;
