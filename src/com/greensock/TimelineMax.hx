...
extern class TimelineMax extends TimelineLite
{
	 ...
	 * @return
	 */
	public function addCallback(_callback:Dynamic, position:Dynamic, ?params:Array<Dynamic>, ?scope:Dynamic):TimelineMax;
	 ...
	 * @return
	 */
	public function removeCallback(_callback:Dynamic, ?timeOrLabel:Dynamic):TimelineMax;
